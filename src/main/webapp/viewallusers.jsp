...
<h3 align="center"><u>All Users Of AutoFleet</u></h3> 
...
<td><img src='displayprofilepic?id=${us.id}' width="60%" height="60%"></td>
<td><c:out value="${us.lastname}" /></td> 
<td><c:out value="${us.email}" /></td>
<td><c:out value="${us.phonenumber}" /></td>  
<td>
<a href='<c:url value="view?id=${us.id}"></c:url>'>View</a>
</td>
